    ...
    try {
        ...
        if ($id) {
            ...
            $sql = "UPDATE projects SET 
                    ...
                    year = ?, area = ?, client = ?, description = ?";
            $params = [$title, $slug, $category_id, $location, $year, $area, $client, $description];
            ...
            // Insert new project
            $stmt = $db->prepare("
                INSERT INTO projects (title, slug, category_id, location, year, area, client, description, featured_img) 
                VALUES (?, ?, ?, ?, ?, ?, ?, ?, ?)
            ");
            $stmt->execute([$title, $slug, $category_id, $location, $year, $area, $client, $description, $featured_img]);
            $id = $db->lastInsertId();
